...
BUILTIN_TOOL_DESCRIPTIONS: Dict[str, str] = {
    ...
    "manage_video": "Video project management: upload clips, list projects, create projects, get details, update project, delete project, analyze content format, suggest edit plans, preview timeline frames, and start rendering.",
    "publish_youtube": "Publish a rendered video project to YouTube with custom title, description, tags, category, and privacy settings.",
...
class ToolIndex:
    ...
    _KEYWORD_HINTS = {
        ...
        frozenset({"note", "todo", "reminder", "remind", "checklist", "remember to"}):
            {"manage_notes"},
        frozenset({"video", "clip", "trim", "render", "edit video", "edit clips", "youtube", "publish video"}):
            {"manage_video", "publish_youtube"},
